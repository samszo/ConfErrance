...
+-----------------------------------------------------------------------------+-------------------------------------------------------------+
| ![](docs/img/logo_paris8_Couleurs%20officielles.png){style="height:100px;"} | ![](docs/img/logo-para-outlines.png){style="height:100px;"} |
+-----------------------------------------------------------------------------+-------------------------------------------------------------+
...
[Voir en plein écran](docs/HDR/slide.html)

```{=html}
<iframe width="800" height="600" src="docs/HDR/slide.html)" title="Support de présentation"></iframe>
```
...
[Voir en ligne le CV complet](../../HDR/docs/cv/cv.html){style="target"}

...
| ![](docs/img/logo_paris8_Couleurs.png){height=100} | ![](docs/img/logo-para-outlines.png){height=100} | ![](docs/img/qrcode_samszo.github.ioConfErrance_ia-iv-human-2026.png){height=120} |
|-----------|-----------|-----------|
...
[Voir en plein écran](ia-iv-humain-2026/slide.html){target="_blank"}

...
Pour aider à une meilleur compréhension de ces phénomènes, nous proposons une méthode d'analyse de ces écosystèmes qui donnent aux chercheurs les moyens de construire des points de vue spécifiques, de les partager avec d'autres et de voir leurs évolutions. Cette méthode s'appuie sur une modélisation onto-éthique des existences informationnelles [@szoniecky2019; @szoniecky2020; @szoniecky2023] qui peuplent ces environnements. Nous nous basons sur cinq principes théoriques :

-   les connaissances se produisent suivant un cycle continu d'expériences @µ2015 dans le monde physique et dans le monde de la pensée @descola2005.

-   l'analogie est le « moteur » @hofstadterqui relie le discernement et l'action en gardant le souvenir de cette relation qui devient à force de répétition : une manière d'être @latour2012
...
-   Les pliages et leurs capacités à ce faire, ce défaire, ce bloquer dépendent du degrés de flexibilité @clément2021.

...
[Voir en plein écran](http://localhost/samszo/conf_errance/arcanes_2023/slide.html)

```{=html}
<iframe width="800" height="600" src="http://localhost/samszo/conf_errance/arcanes_2023/slide.html" title="Support de présentation"></iframe>
```

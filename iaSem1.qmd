...
3.  **modifier le script python** :
    ...
    -   Préciser :
        ...
        -   l'adresse de l'image ![Image à traiter](images/PXL_20250225_075552954.MP.jpg)
...
[Quels pouvoirs souhaitons-nous développer ?]{style="font-size:32px;"}

## A suivre

1.  Développer ses propres modèles
2.  Mettre en place des processus automatiques utilisant des agents cf. [Veuille sur les agents](https://www.diigo.com/user/luckysemiosis?query=agent)